...
class GUI:
    ...
    def __init__(self, ip_address, port):
        ...
        self.login.configure(width=450, height=400)
        ...
        self.roomLabelName = tk.Label(self.login, text="Room No: ", font="Arial 12")
    ...
    def layout(self):
        ...
        self.Window.configure(width=470, height=550, bg="#f69c1a")
        ...
        self.labelBottom = tk.Label(self.Window, bg="#ffffff", height=80)
        ...
        self.labelFile = tk.Label(self.Window, bg="#e1ddd6", height=70)
